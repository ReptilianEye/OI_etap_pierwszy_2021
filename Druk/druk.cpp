...
public:
    ...
    przylozonySzablon(int i, int j, int kier)
    {
        x = i;
        y = j;
        dir = kier;
...
bool sprawdzSzablon(string szablon)
{
    ...
    int i = 0, j = 0;
    przylozonySzablon pierwszyKrok(i, j, 0);
    ...
    while (!stos.empty())
    {
        ...
        if (kierunek == 0)
        {
            ...
            if (pasuje)
            {
                przylozonySzablon dodawany(kolejneWolne.first, kolejneWolne.second, 0);
                for (int k = 0; k < dlugoscSzablonu; k++)
                {
        ...
        else if (kierunek == 1)
        {
            ...
            if (pasuje)
            {
                przylozonySzablon dodawany(kolejneWolne.first, kolejneWolne.second, 1);
                for (int k = 0; k < dlugoscSzablonu; k++)
                {
